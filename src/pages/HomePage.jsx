                        ...
                        <div key={product._id} className="bg-white rounded-xl overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-100 group">
                            <div className="h-64 bg-gray-100 relative overflow-hidden">
                                <Link to={`/product/${product._id}`}>
                                    <AnimatedImage src={product.image || 'https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=800&q=80'} alt={product.name} className="w-full h-full object-cover" />
                                </Link>
                                <Link to={`/product/${product._id}`}>
                ...
                <section className="py-20 bg-white">
                    <div className="container mx-auto px-4">
                        <ScrollReveal>
                            ...
                            <div className="flex overflow-x-auto pb-8 gap-8 md:gap-12 no-scrollbar justify-start md:justify-center scroll-smooth">
                                {[
                                    ...
                                    <Link to={`/shop?category=${cat.name}`} key={idx} className="flex flex-col items-center group flex-shrink-0">
                                        ...
                                        <h3 className="font-bold text-gray-800 group-hover:text-primary transition-colors whitespace-nowrap">{cat.name}</h3>
                                    </Link>
                                ))}
                            </div>
                        </ScrollReveal>
