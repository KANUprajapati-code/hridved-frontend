    ...
    return (
        <AnimatedPage>
            <div className="min-h-screen bg-background">
                {/* Hero Section */}
                <section className="relative min-h-[300px] sm:h-[600px] md:h-[700px] flex items-center overflow-hidden bg-primary">
                    ...
                    <div className="container mx-auto px-4 relative z-10 py-8 sm:py-0">
                        <ScrollReveal>
                            <div className="max-w-xl text-white">
                                <span className="bg-secondary text-primary font-bold px-2 py-0.5 rounded-full text-[8px] md:text-sm uppercase tracking-wider mb-1 md:mb-4 inline-block">
                                    Natural Care
                                </span>
                                <h1 className="text-2xl sm:text-4xl md:text-7xl font-display font-bold mb-2 md:mb-6 leading-tight">
                                    {content?.hero?.title || <>Ancient Ayurveda.<br className="hidden sm:block" /> Modern Wellness.</>}
                                </h1>
                                <p className="text-[9px] sm:text-xs md:text-xl mb-4 md:mb-8 text-gray-100 font-light max-w-[150px] sm:max-w-sm md:max-w-lg leading-relaxed">
                                    {content?.hero?.subtitle || "Pure formulations for your modern lifestyle."}
                                </p>
                                <div className="flex flex-wrap gap-2 md:gap-4">
                                    <Link to="/shop">
                                        <AnimatedButton className="bg-secondary text-primary px-3 md:px-8 py-1 md:py-3 rounded-full text-[9px] md:text-sm font-bold hover:bg-white transition-colors duration-300 border-none">
                                            {content?.hero?.ctaText || "Shop Now"}
                                        </AnimatedButton>
                                    </Link>
                                    <Link to="/consultation">
                                        <AnimatedButton variant="outline" className="bg-transparent border-2 border-white text-white px-3 md:px-8 py-1 md:py-3 rounded-full text-[9px] md:text-sm font-bold hover:bg-white hover:text-primary transition-colors duration-300">
                                            Consult
                                        </AnimatedButton>
                                    </Link>
                                </div>
