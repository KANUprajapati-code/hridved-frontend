            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
                ...
                {message && (
                    <motion.div
                        ...
                        className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded relative text-sm"
                    >
                        {message}
                    </motion.div>
                )}
                ...
                <motion.div variants={itemVariants} className="space-y-3">
                    <GoogleAuthButton text="Sign up with Google" redirect={redirect} />
                    <FacebookAuthButton text="Sign up with Facebook" redirect={redirect} />
                </motion.div>
